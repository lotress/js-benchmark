...
var addCase, argmax, argmin, avg, bench, cases, compare, exec, getStdPersent, p, prepare, printResult, r, readline, run, runSamples, sampleStd, setPrepare, sum, time, toFixed3;
...
printResult = (item) => {
  ...
  result = ['', 'average time:', `${toFixed3(item.avg / 1e6)}ms`, `±${getStdPersent(item)}%`];
